...
//   // ✅ Stats now updated by HoldingsCard with LIVE prices
//   const [stats, setStats] = useState({
//     totalValue: 0,
//     totalInvested: 0,
//     totalGain: 0,
...
//       const data = await getPortfolioHoldings(portfolioId);
//       setHoldings(data || []);
//       // ✅ Don't calculate stats here — let HoldingsCard do it with LIVE prices
//     } catch (err) {
//       setHoldings([]);
//     } finally {
//       setHoldingsLoading(false);
...
//   // ✅ Called by HoldingsCard with LIVE stats
//   const handleStatsUpdate = (newStats) => {
//     setStats({
//       totalValue: newStats.totalValue || 0,
//       totalInvested: newStats.totalInvested || 0,
//       totalGain: newStats.totalGain || 0,
//     });
//   };
...
//         {/* ✅ Stats Cards — Now show LIVE data */}
//         <div className="stats-row">
//           <div className="stat-card invested">
//             <div className="stat-card-icon">
//               <Briefcase size={22} />
